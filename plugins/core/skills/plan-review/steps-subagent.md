...
```
Task(subagent_type: "core:scope-reviewer", model: "sonnet", prompt: "...")
Task(subagent_type: "core:architecture-reviewer", model: "sonnet", prompt: "...")
Task(subagent_type: "core:risk-reviewer", model: "sonnet", prompt: "...")
