...
Codex が利用可能な場合、RED/GREEN/REVIEW を Codex に委譲する。詳細は [docs/PHILOSOPHY.md](docs/PHILOSOPHY.md) 参照。
...
| Small-Medium | plan mode → accept edits on | spec → Codex plan review → approve → sync-plan → auto-orchestrate |
