...
|---------|-------------|----------|
| frontmatter `status:` | 現在のフェーズ (INIT/KICKOFF/RED/GREEN/REFACTOR/REVIEW) | Yes |
...
`status` の有効値: `INIT`, `KICKOFF`, `RED`, `GREEN`, `REFACTOR`, `REVIEW`
...
| KICKOFF | テスト作成を開始 | /red |
| RED | 実装を開始 | /green |
| GREEN | 品質改善 | /refactor (delegates to /simplify) |
