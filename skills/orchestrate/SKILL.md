...
Skill(dev-crew:cycle-retrospective): 失敗-成功 insight を抽出、retro_status を captured/resolved に遷移。abort signal 受信時は BLOCK → ユーザー判断仰ぐ。詳細: [reference.md](reference.md#block-2f)
