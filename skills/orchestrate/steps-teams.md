...
```
Task(subagent_type: "general-purpose", team_name: "dev-cycle", name: "socrates", mode: "plan")
```
...
```
Task(subagent_type: "general-purpose", team_name: "dev-cycle", name: "architect")
→ Skill(plan) 実行
→ 結果報告
...
```
Task(subagent_type: "general-purpose", team_name: "dev-cycle", name: "refactorer")
